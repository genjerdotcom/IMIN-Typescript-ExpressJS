...
import Services from "../../services/IngredientStatesService";

class IngredientStatesController implements IControllers {
...
export default new IngredientStatesController();